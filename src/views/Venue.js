...
import {Box, CardHeader, CardMedia, ImageList, ImageListItem, Tab, Tabs, Typography} from "@mui/material";
...
const hotels2 = [
    {
        ...
        address: '02 Trung Nu Vuong Street, Ward 1, Vinh Long City, Vinh Long Province',
        description:<>
            Sai Gon - Vinh Long hotel is a member of Saigontourist Group. Located in the heart of Vinh Long city, a tourist city in the western region belong to Mekong Delta, Sai Gon - Vinh Long consists of 84 luxurious rooms with international standard. Being proud to offer visitors rest stop, premier dining, various kinds of entertainment and other services, Sai Gon - Vinh Long will make your stay in Vinh Long a very pleasant one to remember.
            <br/>(0270) 387 9988 – (0270)387 9989
            <br/>info@saigonvinhlonghotel.com
        </>,
        images:[
    ...
    },
    {
        ...
        description:<>
            Set in Vinh Long, 400m from MTU, Ngoc Hung Hotel offers accommodation with a restaurant, free private parking, a bar and a shared lounge. This 3-star hotel offers a 24-hour front desk and room service. The hotel features family rooms. At the hotel, every room includes a desk, a flat-screen TV, a private bathroom, bed linen and towels. Ngoc Hung Hotel provides certain units with lake views, and every room is fitted with a balcony. The units at the accommodation feature air conditioning and a wardrobe.
            <br/>Tel: +84 2703856868
        </>,
        images:[
            {img: require(`./../assets/images/hotel/ngochung1.jpg`),rows:2,cols:2},
            {img: require(`./../assets/images/hotel/ngochung2.jpg`),rows:2,cols:1},
            {img: require(`./../assets/images/hotel/ngochung3.jpg`),rows:2,cols:1},
        ],
        // url:"https://hochiminhcity.equatorial.com/?utm_source=local&utm_medium=organic&utm_campaign=Google%20My%20Business",
        // book:"https://be.synxis.com/?adult=1&arrive=2024-12-08&chain=24320&child=0&currency=VND&depart=2024-12-09&hotel=6000&level=hotel&locale=en-US&rooms=1"
    }
    ...
    render() {
        return (
            <React.Fragment>
                    ...
                    inside: <>
                        ...
                        <div className={"tabsPanel"}>
                            <TabPanel value={this.state.selectedPlace} index={0}>
                                <p>In November 10, ICEBA2024 hosted at <strong>VNUHCM-University of Science</strong> 227 Nguyen Van Cu Str., Dist. 5, Ho Chi Minh city, Vietnam. </p>
                            ...
                            <TabPanel value={this.state.selectedPlace} index={1}>
                                <p>In November 11-12, ICEBA2024 hosted at <strong>MienTay Construction University</strong> 20B Pho Co Dieu Str., Ward 3, Vinh Long city, Vietnam. </p>
                                <Grid container spacing={2}>
                                    <Grid item xs={12}>
                                        <Carousel autorotate={true} style={{display:'flex'}}>
                                            <CarouselItem>
                    ...
                    inside:<>
                        <div className={"tabsPanel"}>
                            ...
                            <TabPanel value={this.state.selectedPlace} index={1}>
                                <p>There are 3 recommended hotels near the conference. </p>
                                <Grid container spacing={2}>
                                    {hotels2.map((h,hi)=><Grid item xs={12} style={{zIndex: 2}} key={hi}>
                                        <Paper elevation={24}>
                                            <div style={{padding: 20}}>
                                                <Typography variant={'h4'}>{h.name}</Typography>
                                                <Typography variant={'subtitle2'}>{h.address}</Typography>
                ...
                <HeroFull content={{title: 'Tourism',
                    inside:<>
                        <div className={"tabsPanel"}>
                            <TabPanel value={this.state.selectedPlace} index={0}>
                                This year we don't provide tourism info in Ho Chi Minh city. Please check Vinh Long tab.
                            </TabPanel>
                            <TabPanel value={this.state.selectedPlace} index={1}>
                                <p>Coming to Vinh Long, visitors have chance to walk among the trees, relax in hammocks, try all kinds of delicious tropical fruits in the gardens of An Binh and Binh Hoa Phuoc islands. Several popular places are <strong>Mr. Sau Giao's Flower Garden, Mr. Muoi Day's Stilt-House, and Mr. Hai Hoang's Old House</strong>, CocoHome Vinh Long, especially is 'Kingdom of Brick Kilns’, Mang Thít County.</p>
                                ...
                                <p>
                                    Besides, Vinh Long has many pagodas, communal houses such as Van Thanh Temple, Long Thanh Communal House, Ngoc Vien Vihara, Phuoc Hau, Tien Chau, Saghamangala pagodas...
                                </p>
                                <p>
                                    Vinh Long also has many craft villages specializing in producing coconut products, handicraft products from water hyacinth leaves, candies, and many other handmade items.
                                </p>
                                <Card sx={{ width: '100%' }}>
                                    <CardMedia
                                        component="img"
                                ...
                                <GenericSection>
                                    ...
                                    <div style={{textAlign:'left'}}>
                                        ...
                                        <p>Vinh Long not only has sweet fruits but also is a land of great people. Besides the Western river garden tourist style. Visitors will visit the relic Van Thanh Temple, Vinh Long Temple. It’s located on the bank of Long Ho River (in Ward 4- Vinh Long City). This is one of the first three sacred shrines built in the South with Van Thanh Temple of Bien Hoa (in Dong Nai province) and Van Thanh Temple (present-day Saigon).
                                Here, visitors will enjoy the peace, cool, relax the spirit, admire the ancient architecture. It’s one of the best way to learn more about the culture and history of the Vietnamese people and show their sincerity grateful to the predecessors. </p>
                                        <h4>4. Hoang Hao Ecotourism Area</h4>
                                        <p>It is located on Highway 57, 2 km from Dinh Khao ferry, in Thanh Duc commune, Long Ho district, Vinh Long province. This is a brand new, super beautiful eco-tourist area of Vinh Long province. This place not only possesses the cool green scenery of the West with extremely fresh air; But there are also mini houses with thatched roofs, corrugated iron roofs, and a strikingly colourful wall below.</p>
                                        <h4>5. Vinh Sang Eco-Tourism Area</h4>
                                        <p>If you ask a place for collective entertainment in Vinh Long, probably many people will show you to Vinh Sang eco-tourism area. Vinh Sang farm has a triangular shape with a prime point of one side-lying on the banks of the Co Chien River, opposite Vinh Long city.
                                Perhaps nowhere outside this tourist area allows you to admire many rare animals. Such as bears, goats, pelicans, python, mangrove, star deer, boar, pink-cheeked gibbons, monkeys, peacocks, chickens. Especially in Vinh Sang, the crocodile farming area of about 200m2 will be a paradise for those who like strong feelings.
                                            Possessing such unique points, the resort still creates a feeling of closeness like a real Southern garden. The spacious and open space is extremely suitable for fun “wild”: grass slide, try shooting skills, kick cock, throwing balls, blindfolded ostrich feathers, winning fishing … If you do not like noise, solo travellers can enjoy the feeling of peace in the fishing huts. </p>
                                        <h4>6. Tra On Floating Market</h4>
                                        <p>If you want to learn about the cultural characteristics of the people of Vinh Long, go to Tra On floating market. About 250m from Tra On, the floating market downstream of the Hau River. It’s length of over 300m, often meeting according to the country so the big country is crowded.
                                            Tra On Floating Market is like a wholesale market that distributes agricultural products to many other small markets in the province. Therefore, even if you visit the market at any time of the day, you will see a bustle of boats. </p>
                                        <h4>7. My Thuan Bridge</h4>
                                        <p>This graceful architectural bridge is a collaboration between experts, engineers and workers from Australia and Vietnam. The bridge outside the “main duty” is to connect Vinh Long and Ho Chi Minh City also represents a very good symbolic mission for the hometown city.
                                            Tourists who have the opportunity to visit the West or Vinh Long tourism will stop to check-in at this bridge as a commemoration of their trip. As for the young people who love to travel in Vinh Long, the bridge has many extreme “virtual living” niches, creating the perfect background to mark the moments of youth who are passionate about exploring.</p>
                                        <h4>8. Khmer Pu Ly Pagoda</h4>
                                        <p>Phu Ly Pagoda is located in Dong Thanh Commune, Binh Minh District, Vinh Long Province. As an ancient temple built by the Khmer people has a very unique architecture, characteristic of Khmer culture. Especially the combination of Indian, Thai and Cambodian architecture. According to records, Phu Ly pagoda was built by the Khmer in 1672. Up to now, the pagoda is nearly 350 years old, but its ancient beauty is still intact.
                                            The temple has a quite spacious campus. In the palace, there are many Buddha pictures, outside there is a giant stone Buddha statue is very solemn and majestic. Phu Ly Pagoda is a sacred place hiding many mysterious anecdotes. Ancient features of the temple are adorned with ancient star trees and palm trees in the temple garden.</p>
                                        <h4>9. Islet May</h4>
                                        <p>It is a large islet located on the Hau River in two communes Phu Thanh, Luc Si Thanh, in Tra On district, Vinh Long province. Cu Lao May has inherited the freshwater and alluvium of the Hau Giang River. It’s lush fruit gardens all year round, becoming an extremely attractive garden tourist destination. Coming to Cu Lao May, you will visit picking specialities: rambutan, longan, grapefruit … enjoy folk dishes. Such as Garden Chicken Porridge, lemongrass chicken stew or pangasius hot pot cooked with Bananas with available vegetables, grilled snakehead fish …
                                You also have the opportunity to learn about the idyllic lives of the local people, immerse yourself in the cool air.</p>
                                        <br/>
                                        <strong>
                                            <p style={{textDecoration:"underline"}}>Some interesting things you should know when traveling in Vinh Long</p>
                                        ...
                                        <div style={{width:'100%'}}>
                                            <Card sx={{ width: '100%',maxWidth:400, margin:'auto' }}>
                                                <CardMedia
                                                    component="img"
                                        ...
                                        <p>Don’t forget to go to the ditch to bail fishes then enjoy the grilled snake-head dish made by the fishes caught yourself.</p>
                                    </div>
                                </GenericSection>
                            </TabPanel>
                        </div>
