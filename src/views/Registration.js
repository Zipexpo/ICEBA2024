        ...
        return (
            <React.Fragment>
                ...
                <GenericSection topOuterDivider>
                    <h2 className={"mt-0 center-content"}>Important Author Information</h2>
                    ...
                    <p>
                        The author registration deadline is {deadline[0].date}.
                    </p>
                    <ul>
                    ...
                    <p>
                        For questions regarding paper submissions, please contact secretary at <a href={"mailto:5iceba2024@gmail.com"}>5iceba2024@gmail.com</a>.
                    </p>
                    {/*<p>*/}
                ...
                <GenericSection topOuterDivider>
                    ...
                    <p>
                        All refund/cancellation requests must be received in writing to registration by <span style={{color: 'red'}}>{deadline[1].date}</span>,
                        11:59 PM.
                    </p>
                    <p>
                ...
                <HeroFull content={{title:<a target="_blank" href="https://forms.gle/gRbujFsLi9fmRUe47">REGISTER NOW!</a>,
                    inside:<>
